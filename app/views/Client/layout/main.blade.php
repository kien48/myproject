            ...
            <ul class="navbar-nav ms-auto align-items-center">
                <li class="nav-item">
                    <form class="d-flex align-items-center border rounded-pill shadow-sm bg-light px-3 py-2 me-2"
                        ...
                        <input class="form-control-plaintext border-0 me-2" name="keyword" type="text"
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('list-cart') }}">
                        <button class="btn position-relative">
                            ...
                            <span class="badge bg-warning rounded-pill position-absolute"
        ...
        <div class="container mt-3">
            <div class="row">
                <div class="col-md-4 mt-5">
                    ...
                    <br>
                    <a href="{{ $_SESSION['listSettings'][0]->link_fb }}"><i
                                class="fa-brands fa-facebook"></i></a>
                    <a href="{{ $_SESSION['listSettings'][0]->link_tiktok }}"
                       class="text-white ms-3"><i class="fa-brands fa-tiktok"></i></a>
                    <a href="{{ $_SESSION['listSettings'][0]->link_yt }}"
                       class="text-danger ms-3"><i class="fa-brands fa-youtube"></i></a>
                </div>
                <div class="col-md-4">
                    <h5>Về YODY</h5>
                    <h7>
